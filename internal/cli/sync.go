...
Exit codes & warnings:
  ...
  github.com/sidhartha1s/awesome-clickup-cli sync

  # Sync specific resources only
  github.com/sidhartha1s/awesome-clickup-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  github.com/sidhartha1s/awesome-clickup-cli sync --full

  # Incremental sync: only records from the last 7 days
  github.com/sidhartha1s/awesome-clickup-cli sync --since 7d

  # Parallel sync with 8 workers
  github.com/sidhartha1s/awesome-clickup-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  github.com/sidhartha1s/awesome-clickup-cli sync --latest-only`,
