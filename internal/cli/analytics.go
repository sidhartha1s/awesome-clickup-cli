...
Data must be synced first with the sync command.`,
  ...
  github.com/sidhartha1s/awesome-clickup-cli analytics --type messages

  # Group by a field
  github.com/sidhartha1s/awesome-clickup-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  github.com/sidhartha1s/awesome-clickup-cli analytics --type messages --group-by channel_id --limit 10 --json`,
