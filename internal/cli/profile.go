...
func profileStorePath() (string, error) {
	...
	dir := filepath.Join(home, ".github.com/sidhartha1s/awesome-clickup-cli")
...
present (other than --profile and --config).`,
		Example: `  github.com/sidhartha1s/awesome-clickup-cli profile save my-defaults --json --compact
  github.com/sidhartha1s/awesome-clickup-cli profile save tonight-defaults --region US`,
...
func newProfileUseCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/sidhartha1s/awesome-clickup-cli profile use my-defaults
  github.com/sidhartha1s/awesome-clickup-cli profile use tonight-defaults --json`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newProfileListCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/sidhartha1s/awesome-clickup-cli profile list
  github.com/sidhartha1s/awesome-clickup-cli profile list --json`,
...
func newProfileShowCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/sidhartha1s/awesome-clickup-cli profile show my-defaults
  github.com/sidhartha1s/awesome-clickup-cli profile show tonight-defaults --json`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			p, err := GetProfile(args[0])
			if err != nil {
...
func newProfileDeleteCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/sidhartha1s/awesome-clickup-cli profile delete my-defaults --yes
  github.com/sidhartha1s/awesome-clickup-cli profile delete old-profile --yes --json`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			name := args[0]
			s, err := loadProfileStore()
