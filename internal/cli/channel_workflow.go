...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  github.com/sidhartha1s/awesome-clickup-cli workflow archive

  # Full re-archive (ignore previous sync state)
  github.com/sidhartha1s/awesome-clickup-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  github.com/sidhartha1s/awesome-clickup-cli workflow status

  # Show status as JSON
  github.com/sidhartha1s/awesome-clickup-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("github.com/sidhartha1s/awesome-clickup-cli")
			}
