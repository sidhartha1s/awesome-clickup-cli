...
person. Helps identify overloaded team members and unbalanced workload.`,
  ...
  github.com/sidhartha1s/awesome-clickup-cli load

  # Limit results
  github.com/sidhartha1s/awesome-clickup-cli load --limit 10

  # Output as JSON
  github.com/sidhartha1s/awesome-clickup-cli load --json`,
