...
the specified number of days. Useful for identifying forgotten or blocked work.`,
  ...
  github.com/sidhartha1s/awesome-clickup-cli stale

  # Find items not updated in 14 days
  github.com/sidhartha1s/awesome-clickup-cli stale --days 14

  # Filter by team
  github.com/sidhartha1s/awesome-clickup-cli stale --days 7 --team backend

  # Output as JSON
  github.com/sidhartha1s/awesome-clickup-cli stale --days 30 --json`,
