...
but do not stop the import.`,
  ...
  github.com/sidhartha1s/awesome-clickup-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  github.com/sidhartha1s/awesome-clickup-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | github.com/sidhartha1s/awesome-clickup-cli import <resource> --input -`,
