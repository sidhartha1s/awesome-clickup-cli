...
native streaming instead of polling.`,
  ...
  github.com/sidhartha1s/awesome-clickup-cli tail --interval 10s

  # Tail a specific resource
  github.com/sidhartha1s/awesome-clickup-cli tail messages --interval 5s

  # Pipe to jq for filtering
  github.com/sidhartha1s/awesome-clickup-cli tail events --interval 30s | jq 'select(.type == "error")'`,
